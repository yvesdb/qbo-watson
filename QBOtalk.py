...
#        self.ai = apiai.ApiAI(CLIENT_ACCESS_TOKEN)
	...
	print "QBOTalk Init method"
	self.assistant = AssistantV2(
     		version='2018-11-08',
     		## url is optional, and defaults to the URL below. Use the correct URL for your region.
    		url='https://gateway-syd.watsonplatform.net/assistant/api',
     		iam_apikey='x6CRR4eNCx0J72LDxfHQuRkQM_X-cQolrAQ0J3uG15P0')
	session = self.assistant.create_session("4e258667-0e0c-478c-be78-d5e5d58742fe").get_result()
    ...
    def Decode(self, audio):
	    ...
	    print "LISTEN: " + str
	    print "Going to call Watson Assistant " + self.session_id
...
#            response = request.getresponse()
	    response = self.assistant.message(
    		"4e258667-0e0c-478c-be78-d5e5d58742fe",
    		self.session_id,
    		input={'text': str}
		).get_result()
	    ...
	    print "Json DUMP " + jsonresp
            str_resp = response['output']['generic'][0]['text']
	    print(str_resp)
